...
import { CompleteAppt } from './sps/CompleteAppt';
    ...
    <>
      <HashRouter>
        <Routes> 
          ...
          <Route path = "/assign_doctor_to_appointment" element={<AssignDoctorToAppt/>} />
          ...
          <Route path = "/complete_appointment" element={<CompleteAppt/>} />
